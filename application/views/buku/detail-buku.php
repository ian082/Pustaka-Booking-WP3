...
<div data-aos="zoom-out-up" data-aos-duration="1500" class="x_panel" align="center">
    <div class="x_content">
        <div class="row">
                ...
                <div class="thumbnail" style="height: auto; position: relative; left: 100%; width: 200%;">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            ...
                            <?php
                            if ($stok < 1) {
                                echo "<i class=''>Stok Habis</i>";
                            } else {
                                echo "
                                <div class='tombol'>
                                    <a class='' href='" . base_url('booking/tambahBooking/' . $id) . "'> Booking</a>
                                </div>";
                            }
                            ?>
                        </p>
